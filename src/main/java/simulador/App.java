                ...
                while (actual.getItem().getNumero() != -1) {
                        ...
                        if (actual.getItem().getNumero() != -1) { // Si no es el fin de simulacion
                                        ...
                                        if (actual.getTipo() == 1) {
                                                ...
                                                if (servidorMediano1.isEstado() == false)
                                                        ...
                                                        if (servidorMediano2.getQueue().getSize() < aux) {
                                                                ...
                                                                s = 2;
                                                        } else if (servidorMediano3.getQueue().getSize() < aux) {
                                                                aux = servidorMediano3.getQueue().getSize();
                                                                s = 3;
                                                        } else if (servidorMediano4.getQueue().getSize() < aux) {
                                ...
                                if (servidorPesado.isEstado()) {
                                        System.out.print("Ocupada con vuelo " + servidorPesado.getItem().getNumero()
                                                        + ". Cola de espera: ");
                                        servidorPesado.getQueue().mostrarCola();
                                } else
                                        System.out.println("Libre");

                                System.out.print("* Pista Cabotaje 1: ");
                                if (servidorMediano1.isEstado()) {
                                        System.out.print("Ocupada con vuelo " + servidorMediano1.getItem().getNumero()
                                                        + ". Cola de espera: ");
                                        servidorMediano1.getQueue().mostrarCola();
                                } else
                                        System.out.println("Libre");

                                System.out.print("* Pista Cabotaje 2: ");
                                if (servidorMediano2.isEstado()) {
                                        System.out.print("Ocupada con vuelo " + servidorMediano2.getItem().getNumero()
                                                        + ". Cola de espera: ");
                                        servidorMediano2.getQueue().mostrarCola();
                                } else
                                        System.out.println("Libre");

                                System.out.print("* Pista Cabotaje 3: ");
                                if (servidorMediano3.isEstado()) {
                                        System.out.print("Ocupada con vuelo " + servidorMediano3.getItem().getNumero()
                                                        + ". Cola de espera: ");
                                        servidorMediano3.getQueue().mostrarCola();
                                } else
                                        System.out.println("Libre");

                                System.out.print("* Pista Cabotaje 4: ");
                                if (servidorMediano4.isEstado()) {
                                        System.out.print("Ocupada con vuelo " + servidorMediano4.getItem().getNumero()
                                                        + ". Cola de espera: ");
                                        servidorMediano4.getQueue().mostrarCola();
                                } else
                                        System.out.println("Libre");

                                System.out.print("* Pista Privada: ");
                                if (servidorLiviano.isEstado()) {
                                        System.out.print("Ocupada con vuelo " + servidorLiviano.getItem().getNumero()
                                                        + ". Cola de espera: ");
                                        servidorLiviano.getQueue().mostrarCola();
                                } else
                                        System.out.println("Libre");
                                */
                        } else {
                                ...
                                if (!servidorPesado.isEstado())
                                        servidorPesado.setTiempoOcioso(
                                                        actual.getTiempo() - servidorPesado.getTiempoInicioOcio());
                                if (!servidorMediano1.isEstado())
                                        servidorMediano1.setTiempoOcioso(
                                                        actual.getTiempo() - servidorMediano1.getTiempoInicioOcio());
                                if (!servidorMediano2.isEstado())
                                        servidorMediano2.setTiempoOcioso(
                                                        actual.getTiempo() - servidorMediano2.getTiempoInicioOcio());
                                if (!servidorMediano3.isEstado())
                                        servidorMediano3.setTiempoOcioso(
                                                        actual.getTiempo() - servidorMediano3.getTiempoInicioOcio());
                                if (!servidorMediano4.isEstado())
                                        servidorMediano4.setTiempoOcioso(
                                                        actual.getTiempo() - servidorMediano4.getTiempoInicioOcio());
                                if (!servidorLiviano.isEstado())
                                        servidorLiviano.setTiempoOcioso(
                                                        actual.getTiempo() - servidorLiviano.getTiempoInicioOcio());
                                ...
                                int canTotalVuelos = Item.getCantidadItemsPesado() + Item.getCantidadItemsMediano()
                                ...
                                Estadisticas.tiempoMedioOciosidad(
                                                servidorMediano1.getTiempoOcioso() + servidorMediano2.getTiempoOcioso()
                                                                + servidorMediano3.getTiempoOcioso()
                                                                + servidorMediano4.getTiempoOcioso(),
                                                Item.getCantidadItemsMediano());
                                Estadisticas.recaudacion(servidorMediano1.getRecaudacion()
                                                + servidorMediano2.getRecaudacion() + servidorMediano3.getRecaudacion()
